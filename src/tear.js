...
export class TearCanvas {
    constructor(canvas, opts) {
        ...
        Object.defineProperty(this, "tearProgress", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        }); // 0 → 1 (proportion across width)
        ...
        Object.defineProperty(this, "velocity", {
            ...
            writable: true,
            value: 0
        }); // px/frame, used to modulate jaggedness
        ...
        // drop animation
        Object.defineProperty(this, "dropping", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "dropStart", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    bindEvents() {
        ...
        const onStart = (x, y) => {
            if (this.revealed || this.dropping)
                return;
    ...
    extendTearPath() {
        ...
        const maxJag = jagStyle === 'straight' ? 0
